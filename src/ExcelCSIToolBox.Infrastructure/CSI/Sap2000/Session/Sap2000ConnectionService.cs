    ...
    public class Sap2000ConnectionService : ICSISapModelConnectionService
    {
        ...
        public OperationResult<PointObjectInfo> GetPointCoordinates(string pointName)
        {
            ...
            return CSISapModelPointObjectService.GetByName(
                ...
                sapModelResult.Data,
                pointName,
                (SAP2000v1.cSapModel sapModel, string name, ref double x, ref double y, ref double z) =>
        ...
        public OperationResult<PointRestraintInfo> GetPointRestraint(string pointName)
        {
            ...
            return CSISapModelPointObjectService.GetRestraint(
                ...
                sapModelResult.Data,
                pointName,
                (SAP2000v1.cSapModel sapModel, string name, ref bool[] values) =>
        ...
        public OperationResult<IReadOnlyList<PointLoadInfo>> GetPointLoadForces(string pointName)
        {
            ...
            return CSISapModelPointObjectService.GetLoadForces(
                ...
                sapModelResult.Data,
                pointName,
                (SAP2000v1.cSapModel sapModel, string name, ref int numberItems, ref string[] pointNames, ref string[] loadPatterns, ref int[] caseSteps, ref string[] coordinateSystems, ref double[] f1, ref double[] f2, ref double[] f3, ref double[] m1, ref double[] m2, ref double[] m3) =>
                    sapModel.PointObj.GetLoadForce(name, ref numberItems, ref pointNames, ref loadPatterns, ref caseSteps, ref coordinateSystems, ref f1, ref f2, ref f3, ref m1, ref m2, ref m3, SAP2000v1.eItemType.Objects));
        }
        ...
        public OperationResult<string> GetPointGuid(string pointName)
        {
            ...
            return CSISapModelPointObjectService.GetGuid(
                ...
                sapModelResult.Data,
                pointName,
                (SAP2000v1.cSapModel sapModel, string name, ref string guid) =>
        ...
        public OperationResult<PointGroupAssignmentInfo> GetPointGroupAssignments(string pointName)
        {
            ...
            return CSISapModelPointObjectService.GetGroupAssign(
                ...
                sapModelResult.Data,
                pointName,
                (SAP2000v1.cSapModel sapModel, string name, ref int numberItems, ref string[] groupNames) =>
        ...
        public OperationResult<PointConnectivityInfo> GetPointConnectivity(string pointName)
        {
            ...
            return CSISapModelPointObjectService.GetConnectivity(
                ...
                sapModelResult.Data,
                pointName,
                (SAP2000v1.cSapModel sapModel, string name, ref int numberItems, ref int[] objectTypes, ref string[] objectNames, ref int[] pointNumbers) =>
        ...
        public OperationResult<PointSpringInfo> GetPointSpring(string pointName)
        {
            ...
            return CSISapModelPointObjectService.GetSpring(
                ...
                sapModelResult.Data,
                pointName,
                (SAP2000v1.cSapModel sapModel, string name, ref double[] stiffness) =>
        ...
        public OperationResult<PointMassInfo> GetPointMass(string pointName)
        {
            ...
            return CSISapModelPointObjectService.GetMass(
                ...
                sapModelResult.Data,
                pointName,
                (SAP2000v1.cSapModel sapModel, string name, ref double[] masses) =>
        ...
        public OperationResult<PointLocalAxesInfo> GetPointLocalAxes(string pointName)
        {
            ...
            return CSISapModelPointObjectService.GetLocalAxes(
                ...
                sapModelResult.Data,
                pointName,
                (SAP2000v1.cSapModel sapModel, string name, ref double a, ref double b, ref double c, ref bool advanced) =>
        ...
        {
            return OperationResult<PointDiaphragmInfo>.Failure("SAP2000 PointObj.GetDiaphragm is not available in the referenced SAP2000 API.");
        }
        ...
        public OperationResult SetPointRestraint(IReadOnlyList<string> pointNames, IReadOnlyList<bool> restraints)
        {
            ...
            return CSISapModelPointObjectService.SetRestraint(
                ...
                restraints,
                (SAP2000v1.cSapModel sapModel, string name, ref bool[] values) =>
                    sapModel.PointObj.SetRestraint(name, ref values, SAP2000v1.eItemType.Objects),
                RefreshView);
        }
        ...
        public OperationResult SetPointLoadForce(IReadOnlyList<string> pointNames, string loadPattern, IReadOnlyList<double> forceValues, bool replace, string coordinateSystem)
        {
            ...
            return CSISapModelPointObjectService.SetLoadForce(
                ...
                replace,
                coordinateSystem,
                (SAP2000v1.cSapModel sapModel, string name, string pattern, ref double[] values, bool replaceExisting, string cSys) =>
                    sapModel.PointObj.SetLoadForce(name, pattern, ref values, replaceExisting, cSys, SAP2000v1.eItemType.Objects),
                RefreshView);
        }
        ...
        public OperationResult<FrameObjectInfo> GetFrameByName(string frameName)
        {
            ...
            return CSISapModelFrameObjectService.GetByName(
                ...
                sapModelResult.Data,
                frameName,
                (SAP2000v1.cSapModel sapModel, string name, ref string pointI, ref string pointJ) =>
                    sapModel.FrameObj.GetPoints(name, ref pointI, ref pointJ),
                (SAP2000v1.cSapModel sapModel, string name, ref string sectionName, ref string autoSelectList) =>
        ...
        public OperationResult<IReadOnlyList<FrameLoadInfo>> GetFrameDistributedLoads(string frameName)
        {
            ...
            return CSISapModelFrameObjectService.GetDistributedLoads(
                ...
                sapModelResult.Data,
                frameName,
                (SAP2000v1.cSapModel sapModel, string name, ref int numberItems, ref string[] frameNames, ref string[] loadPatterns, ref int[] loadTypes, ref string[] coordinateSystems, ref int[] directions, ref double[] rd1, ref double[] rd2, ref double[] dist1, ref double[] dist2, ref double[] val1, ref double[] val2) =>
                    sapModel.FrameObj.GetLoadDistributed(name, ref numberItems, ref frameNames, ref loadPatterns, ref loadTypes, ref coordinateSystems, ref directions, ref rd1, ref rd2, ref dist1, ref dist2, ref val1, ref val2, SAP2000v1.eItemType.Objects));
        }
        ...
        public OperationResult<IReadOnlyList<FrameLoadInfo>> GetFramePointLoads(string frameName)
        {
            ...
            return CSISapModelFrameObjectService.GetPointLoads(
                ...
                sapModelResult.Data,
                frameName,
                (SAP2000v1.cSapModel sapModel, string name, ref int numberItems, ref string[] frameNames, ref string[] loadPatterns, ref int[] loadTypes, ref string[] coordinateSystems, ref int[] directions, ref double[] relativeDistance, ref double[] distance, ref double[] value) =>
                    sapModel.FrameObj.GetLoadPoint(name, ref numberItems, ref frameNames, ref loadPatterns, ref loadTypes, ref coordinateSystems, ref directions, ref relativeDistance, ref distance, ref value, SAP2000v1.eItemType.Objects));
        }
        ...
        public OperationResult<IReadOnlyList<ExcelCSIToolBox.Core.Contracts.CSI.CSISapModelLoadCombinationDTO>> GetLoadCombinations()
        {
            ...
            var comboResult = ExcelCSIToolBox.Infrastructure.CSI.Common.Loadings.LoadCombinations.CSISapModelLoadCombinationService.GetLoadCombinations(
                sapModelResult.Data,
                (SAP2000v1.cSapModel sapModel, ref int numberNames, ref string[] names) =>
        ...
        public OperationResult<IReadOnlyList<ExcelCSIToolBox.Core.Contracts.CSI.LoadCombinationItemDTO>> GetLoadCombinationDetails(string combinationName)
        {
            ...
            var detailsResult = ExcelCSIToolBox.Infrastructure.CSI.Common.Loadings.LoadCombinations.CSISapModelLoadCombinationService.GetLoadCombinationDetails(
                sapModelResult.Data,
                combinationName,
        ...
        public OperationResult<LoadCombinationMatrixDto> GetLoadCombinationMatrix()
        {
            ...
            return ExcelCSIToolBox.Infrastructure.CSI.Common.Loadings.LoadCombinations.CSISapModelLoadCombinationService.GetLoadCombinationMatrix(
                sapModelResult.Data,
                (SAP2000v1.cSapModel sapModel, ref int numberNames, ref string[] names) =>
                    sapModel.LoadPatterns.GetNameList(ref numberNames, ref names),
                (SAP2000v1.cSapModel sapModel, ref int numberNames, ref string[] names) =>
        ...
        public OperationResult<IReadOnlyList<string>> GetLoadPatternNames()
        {
            ...
            return ExcelCSIToolBox.Infrastructure.CSI.Common.Loadings.LoadCombinations.CSISapModelLoadCombinationService.GetLoadPatternNames(
                sapModelResult.Data,
                (SAP2000v1.cSapModel sapModel, ref int numberNames, ref string[] names) =>
                    sapModel.LoadPatterns.GetNameList(ref numberNames, ref names));
        }
        ...
        public OperationResult<LoadCombinationApplyResultDto> ApplyLoadCombinationMatrix(IReadOnlyList<LoadCombinationMatrixRowDto> rows)
        {
            ...
            var result = ExcelCSIToolBox.Infrastructure.CSI.Common.Loadings.LoadCombinations.CSISapModelLoadCombinationService.ApplyLoadCombinationMatrix(
                sapModelResult.Data,
                rows,
                (SAP2000v1.cSapModel sapModel, ref int numberNames, ref string[] names) =>
                    sapModel.RespCombo.GetNameList(ref numberNames, ref names),
        ...
        public OperationResult DeleteLoadCombinations(IReadOnlyList<string> loadCombinationNames)
        {
            ...
            var result = ExcelCSIToolBox.Infrastructure.CSI.Common.Loadings.LoadCombinations.CSISapModelLoadCombinationService.DeleteLoadCombinations(
                sapModelResult.Data,
        ...
        public OperationResult<IReadOnlyList<ExcelCSIToolBox.Core.Contracts.CSI.CSISapModelLoadPatternDTO>> GetLoadPatterns()
        {
            ...
            var patternResult = ExcelCSIToolBox.Infrastructure.CSI.Common.Loadings.LoadPatterns.CSISapModelLoadPatternService.GetLoadPatterns(
                sapModelResult.Data,
                (SAP2000v1.cSapModel sapModel, ref int numberNames, ref string[] names) =>
                    sapModel.LoadPatterns.GetNameList(ref numberNames, ref names),
                (SAP2000v1.cSapModel sapModel, string name) =>
        ...
        public OperationResult DeleteLoadPatterns(IReadOnlyList<string> loadPatternNames)
        {
            ...
            var result = ExcelCSIToolBox.Infrastructure.CSI.Common.Loadings.LoadPatterns.CSISapModelLoadPatternService.DeleteLoadPatterns(
                sapModelResult.Data,
                loadPatternNames,
        ...
        public OperationResult<IReadOnlyList<string>> GetFrameSectionNames()
        {
            ...
            if (ret != 0 || names == null)
            {
                return OperationResult<IReadOnlyList<string>>.Failure("Failed to get frame section names from SAP2000.");
            }
        ...
        public OperationResult<IReadOnlyList<string>> GetAreaSectionNames()
        {
            ...
            if (ret != 0 || names == null)
            {
                return OperationResult<IReadOnlyList<string>>.Failure("Failed to get area section names from SAP2000.");
            }
