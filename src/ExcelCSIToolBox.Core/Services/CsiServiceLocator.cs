...
namespace ExcelCSIToolBox.Core.Services
{
    public sealed class CsiServiceLocator
    {
        ...
        public OperationResult<ICSISapModelConnectionService> GetActiveService()
        {
