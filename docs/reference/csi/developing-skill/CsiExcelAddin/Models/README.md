...
- Parsed Excel/table input DTOs should be kept in a shared `Infrastructure/CSISapModel/TableFormats/` folder when the same shape can be used by multiple CSI products.
