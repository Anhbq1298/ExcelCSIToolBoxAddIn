...
namespace ExcelCSIToolBox.RefBuilder
{
    internal static class Program
    {
        private static int Main(string[] args)
        {
            ...
            string refRoot = Path.Combine(root, "docs", "reference", "csi");
            string infrastructureRoot = Path.Combine(root, "src", "ExcelCSIToolBox.Infrastructure");
            ...
            IReadOnlyList<ApiMethodDefinition> etabs = builder.Build("ETABS", Path.Combine(root, "lib", "ETABSv1.dll"));
            IReadOnlyList<ApiMethodDefinition> sap2000 = builder.Build("SAP2000", Path.Combine(root, "lib", "SAP2000v1.dll"));
        ...
        private static string FindRepositoryRoot()
        {
            ...
            {
                if (File.Exists(Path.Combine(directory, "ExcelCSIToolBox.sln")))
                {
                    return directory;
                }
